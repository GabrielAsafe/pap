            ...
            <div  class="Classeformularios">
                ...
                <div class="">
                    <div class="form" id="form">
                        <form action="sepia.php" method="get" id="form1"><!--mudar action em cada form-->
                            ...
                            <input class="input" type="text" readonly="readonly" placeholder="função" value="sepia" name="Função" required><!-- alterar o value em cada função--><br>
                        ...
                        <?php
                            ...
                            foreach($fileList as $filename){
                                ...
                                for($i=1;$i<=count($nomes_das_imagens);$i++){                                
                                    echo("<a href='sepia.php?nome_imagem=$nomes_das_imagens[$i]'> $nomes_das_imagens[$i] </a> <br>"); //mudar essa linha em cada formulário
                        } ?>
                    </div>
