            ...
            <div  class="Classeformularios">
                ...
                <div class="">
                    <div class="form" id="form">
                        <form action="comprimir.php" method="get" id="form1"><!--mudar action em cada form-->
                            ...
                            <input class="input" type="text" placeholder="função" readonly="readonly" value="compress" name="Função" required><!-- alterar o value em cada função--><br>
                            <label for="fname">Extensão:</label><br>
                            <input class="input" type="text" placeholder="Extensão" name="variavel3" ><br>
                            <label for="fname">Qualidade:</label><br>
                            <input class="input" type="text" placeholder="Entre 0 a 100 se for jpg ou  0 e 9 se for png " name="variavel4" ><br>
                        ...
                        <?php
                            ...
                            foreach($fileList as $filename){
                                ...
                                for($i=1;$i<=count($nomes_das_imagens);$i++){                                
                                    echo("<a href='comprimir.php?nome_imagem=$nomes_das_imagens[$i]'> $nomes_das_imagens[$i] </a> <br>"); //mudar essa linha em cada formulário
                        } ?>
                    </div>
