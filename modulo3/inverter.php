            ...
            <div  class="Classeformularios">
                ...
                <div class="">
                    <div class="form" id="form">
                        <form action="inverter.php" method="get" id="form1"><!--mudar action em cada form-->
                            ...
                            <input type="radio" id="radio" name="Função" value="Hflip"><!-- alterar o value em cada função--><label for="fname">Horizontal:</label><br>
                           <input type="radio" id="radio"  name="Função" value="Vflip"><!-- alterar o value em cada função--><label for="fname">Vertical:</label><br> 
                        ...
                        <?php
                            ...
                            foreach($fileList as $filename){
                                ...
                                for($i=1;$i<=count($nomes_das_imagens);$i++){                                
                                    echo("<a href='inverter.php?nome_imagem=$nomes_das_imagens[$i]'> $nomes_das_imagens[$i] </a> <br>"); //mudar essa linha em cada formulário
                        } ?>
                    </div>
