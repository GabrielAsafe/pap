            ...
            <div  class="Classeformularios">
                ...
                <div class="">
                    <div class="form" id="form">
                        <form action="rotacionar.php" method="get" id="form1"><!--mudar action em cada form-->
                            ...
                            <input class="input" type="text" placeholder="função" readonly="readonly" value="rotacao" name="Função" required><!-- alterar o value em cada função--><br>
                            <label for="fname">Valor da função:</label><br>
                            <input class="input" type="text" placeholder="Rotação entre 0 e 360 graus" name="variavel1" >
                        ...
                        <?php
                            ...
                            foreach($fileList as $filename){
                                ...
                                for($i=1;$i<=count($nomes_das_imagens);$i++){                                
                                    echo("<a href='rotacionar.php?nome_imagem=$nomes_das_imagens[$i]'> $nomes_das_imagens[$i] </a> <br>"); //mudar essa linha em cada formulário
                        } ?>
                    </div>
