            ...
            <div  class="Classeformularios">
                ...
                <div class="">
                    <div class="form" id="form">
                        <form action="escalonar.php" method="get" id="form1"><!--mudar action em cada form-->
                            <label for="fname">Nome da imagem:</label><br>
                            <input class="input" type="text" readonly="readonly" placeholder="imagem" value="<?=$nome_imagem?>" name="imagem" required><br>
                            <label for="fname">Nome da função:</label><br>
                            <input class="input" type="text" readonly="readonly" placeholder="função" value="resize" name="Função" required><!-- alterar o value em cada função--><br>
                            <label for="fname">Valor da função:</label><br>
                            <input class="input" type="text" placeholder="Largura  resize" name="width" ><br>
                            <label for="fname">Valor da função:</label><br>
                            <input class="input" type="text" placeholder="Altura resize" name="height" ><br> 
                        ...
                        <?php
                            ...
                            foreach($fileList as $filename){
                                ...
                                for($i=1;$i<=count($nomes_das_imagens);$i++){                                
                                    echo("<a href='escalonar.php?nome_imagem=$nomes_das_imagens[$i]'> $nomes_das_imagens[$i] </a> <br>"); //mudar essa linha em cada formulário
                        } ?>
                    </div>
