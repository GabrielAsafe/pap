            ...
            <div  class="Classeformularios">
                ...
                <div class="">
                    <div class="form" id="form">
                        <form action="info.php" method="get" id="form1"><!--mudar action em cada form-->
                            ...
                            <input class="input" type="text" placeholder="função" readonly="readonly" value="info" name="Função" required><!-- alterar o value em cada função--><br>
                            <div class="caixa_de_texto"><?php $txt_file = fopen('dimensoes.txt','r'); while ($line = fgets($txt_file)) {echo($line); echo nl2br("\n"); }fclose($txt_file);?></div>
                        ...
                        <?php
                            ...
                            foreach($fileList as $filename){
                                ...
                                for($i=1;$i<=count($nomes_das_imagens);$i++){                                
                                    echo("<a href='info.php?nome_imagem=$nomes_das_imagens[$i]'> $nomes_das_imagens[$i] </a> <br>"); //mudar essa linha em cada formulário
                        } ?>
                    </div>
